      ...
      <ul className="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 mx-auto justify-items-center gap-2 ">
        {locations.map((e) => (
          <Link
            ...
            key={e.id}
          >
            <li className="w-[350px] p-6 rounded-lg space-y-3 bg-gradient-to-br from-zinc-900 to-zinc-800 overflow-hidden shadow-lg text-white hover:shadow-2xl hover:scale-105 duration-300 transition-all ">
